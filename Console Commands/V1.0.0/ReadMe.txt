...
This is the first version of my Console Command program.
I haven't developed much use for it yet.
Note: this project was a coding practice.

This was programmed on Visual Studio (.Net 5.0).
...
This software can handle unnecessary spaces, capital and small letters not in order.
Example
Input:
